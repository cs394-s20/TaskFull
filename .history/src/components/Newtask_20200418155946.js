  ...
  return (
    <form onSubmit={e => submitForm(e)}>
      <Grid style={{ padding: "1em" }}>
        ...
        />
          <TextField className="newtaskfield" id="standard-basic" label="Address" />
          <TextField className="newtaskfield" id="standard-basic" label="City" />
          <TextField className="newtaskfield" id="standard-basic" label="State" />
        </DialogContent>
                  <DialogActions>
